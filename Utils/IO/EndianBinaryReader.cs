...
namespace Utils.IO
{
    ...
    public class EndianBinaryReader : IDisposable
    {
        ...
        /// <summary>
        ///     Closes the e.Reader, including the underlying stream..
        /// </summary>
        public void Close()
        {
            Dispose();
        ...
        ///     for this e.Reader. 8 bytes are read.
        /// </summary>
        ...
        ///     for this e.Reader. 16 bytes are read.
        /// </summary>
        ...
        ///     this e.Reader. If no characters have been fully read by the time the stream ends,
        ///     -1 is returned.
        /// </summary>
